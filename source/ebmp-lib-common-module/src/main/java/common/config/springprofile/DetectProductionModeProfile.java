package common.config.springprofile;
...
public class DetectProductionModeProfile {
  ...
  public enum RuntimeMode {
    AWS("aws", "AWS 운영 모드. AWS 운영 서버에서 동작 중일 때", "227"),
    DWMSDEV("dwmsdev", "DWMS 개발 모드. DWMS 개발 서버에서 동작 중일 때", "228"),
  ...
  public static boolean isAwsMode() {
    return RuntimeMode.AWS.equals(getCurrentRuntimeAndDBMode());
  }

  public static boolean isDwmsDevMode() {
    return RuntimeMode.DWMSDEV.equals(getCurrentRuntimeAndDBMode());
  }

  public static boolean isLocalMode() {
    return RuntimeMode.LOCAL.equals(getCurrentRuntimeAndDBMode());
  }
}
