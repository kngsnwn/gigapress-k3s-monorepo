...
@Builder
@Entity
@IdClass(EpcUserMstCommonPK.class)
@Table(name = "EPC_USER_MST")
@NoArgsConstructor(access = AccessLevel.PROTECTED)
@EntityListeners(AuditingEntityListener.class)
public class EpcUserMstCommon {
  ...
  public EpcUserMstCommon(String unqUserId, String cmpyCd, String sabun, String userGbn, String cmpyNm, String empNm, String userId, String userPwd, String email, String userBizType, String deptCd, String bpCd, String psnScn, String dutyScn, String jobScn, String jobDtlScn, String workTelNo, String spTelNo, String homeTelNo, String genScn, String joinDate, String pbtDate, String rstYn,
    String rstDate, String workScn, Long loginCnt, String birthDate, String autoLogin, String workSpot, String workDept, String stdTimeFrom, String stdTimeTo, String cmpyPostNo, String cmpyAddr, String cmpyAddrDtl, String homePostNo, String homeAddr, String homeAddrDtl, String picFileId, String authNo, LocalDateTime authDate, LocalDateTime lastLoginDt, String defaultRedirectSolCd,
    String loaStartDate, String loaEndDate, String affCmpyCd, String enterId, String contents, LocalDateTime pwdChgDt, LocalDateTime successAuthDate, Long sendAuthCnt, String workspace, Long seqNo, String useYn, String frstRgstId, LocalDateTime frstRgstDt, String lastMdfyId, LocalDateTime lastMdfyDt) {
